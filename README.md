...
- 🧠 AI & NLP-based trend detection and sentiment analysis
- 🗺️ Real-time interactive hotspot map dashboard
...
- Improve coastal disaster preparedness
- Enable faster hazard detection and response
...
- **Societal:** Empowers communities as active first responders  
...
- AI-based predictive hazard modeling
